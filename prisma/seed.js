...
async function main() {
  ...
  await prisma.project.createMany({ data: [
    { id: 1, profileId: 1, titulo: 'DevShowcase API', descricao: 'API RESTFul para portfólio', url_repositorio: 'https://github.com/example/devshowcase-api', url_demonstracao: 'https://example.com/api', notaMedia: 4.5, totalFeedbacks: 2 },
    { id: 2, profileId: 2, titulo: 'GestorTarefas', descricao: 'Gerenciador de tarefas', url_repositorio: 'https://github.com/example/task-manager', url_demonstracao: 'https://example.com/tasks', notaMedia: 5, totalFeedbacks: 1 },
    { id: 3, profileId: 3, titulo: 'AutomacaoEmail', descricao: 'Sistema de automação de envio de emails', url_repositorio: 'https://github.com/example/email-automation', url_demonstracao: 'https://example.com/messages', notaMedia: 5, totalFeedbacks: 1 }
  ] });
  ...
  await prisma.feedback.createMany({ data: [
    ...
    { id: 3, projetoId: 2, autor: 'Guilherme Dantas', nota: 5, comentario: 'Muito bom! O sistema é muito eficiente.' },
